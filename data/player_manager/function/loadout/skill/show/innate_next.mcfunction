#> player_manager:loadout/skill/show/innate_next
...
function player_manager:loadout/skill/show/innate_entry.m with storage player_manager:loadout temp.show.current
return run function player_manager:loadout/skill/show/innate_next
