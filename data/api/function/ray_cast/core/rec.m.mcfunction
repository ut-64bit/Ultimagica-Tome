...
# エンティティ
	execute positioned ~-0.125 ~-0.125 ~-0.125 as @n[type=!#lib:no_living,tag=!_owner,tag=!_this,dx=0] positioned ~-0.75 ~-0.75 ~-0.75 if entity @s[dx=0] run return run tag @s add _ray
