...
execute if data storage world:game runtime.stage run function world:game/dispatch/stage/reset.m with storage world:game runtime

data modify storage world:game state set value "lobby"
...
data remove storage world:game runtime
