...
execute if score #ActiveCount _ < #MinimumPlayers _ run return run function world_manager:game/reset
...
execute if score #Game Game.Timer matches 0 run return run function world_manager:game/state/playing/enter
