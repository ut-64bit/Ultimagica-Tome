#> asset:object/proj.wind_whirl/main/
#
# 更新処理
#
...
# 定期的にダメージを与える
	execute if score #t_Interval _ matches 0 run function asset:object/proj.wind_whirl/main/create_attack_data
...
# 演出
	...
	execute if score @s General.Tick matches 4.. run function asset:object/proj.wind_whirl/main/rotate
