...
# ダメージを与える
	...
	execute positioned ~-0.5 ~ ~-0.5 as @e[type=!#lib:no_living,tag=!_owner,tag=!_this,tag=!Game.Observer,tag=!Player.NoCollison,dy=2] unless function api:damage/is_invincible \
