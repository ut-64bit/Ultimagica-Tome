#> asset:object/proj.crystal_bullet/tick/
#
# 毎tick呼び出されるメソッド
#
...
# State
	...
	execute if data storage asset:temp {StateCpy:"delay"} run function asset:object/proj.crystal_bullet/tick/state_delay/
	execute if data storage asset:temp {StateCpy:"idle"} run function asset:object/proj.crystal_bullet/tick/state_idle/
	execute if data storage asset:temp {StateCpy:"move"} run function asset:object/proj.crystal_bullet/tick/state_move/
