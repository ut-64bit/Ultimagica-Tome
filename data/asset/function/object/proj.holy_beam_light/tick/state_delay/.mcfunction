#> asset:object/proj.holy_beam_light/tick/state_delay/
#
...
# 演出
execute if data storage asset:context this{Delay:8} run data merge entity @s {transformation:{scale:[0.5f,0.5f,0.5f]},interpolation_duration:2,start_interpolation:0}
