#> asset:object/particle.spark/register
#
# クラスの登録処理
#
...
# ID
	data modify storage asset:object ID set value "particle.spark"
# フィールド
	# フレーム数
	...
	# billboard
	data modify storage asset:object Field.billboard set value "center"
	# scale
	data modify storage asset:object Field.scale set value 2
