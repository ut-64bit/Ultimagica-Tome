...
# ダメージを与える
	execute positioned ~-1.5 ~-1.5 ~-1.5 as @e[type=!#lib:no_living,tag=!_owner,tag=!_this,tag=!Game.Observer,dx=2,dy=2,dz=2] unless function api:damage/is_invincible run tag @s add _hit
