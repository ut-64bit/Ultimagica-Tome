#> asset:object/proj.fire_shot/register
#
# クラスの登録処理
#
...
# ID
	data modify storage asset:object ID set value "proj.fire_shot"
# フィールド
	# 飛距離
	data modify storage asset:object Field.Range set value 80
	# 移動速度
	data modify storage asset:object Field.Speed set value 7
	# 1ステップあたりの移動距離
