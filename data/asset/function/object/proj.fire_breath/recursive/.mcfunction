...
# 地面との衝突
	execute facing ^ ^-1 ^ positioned ^ ^ ^0.5 run function asset:object/call.m {method:"detect_hit_block"}
...
# 演出
	...
	particle dust{color:16711680,scale:0.5} ^ ^ ^ 0.1 0.1 0.1 0 1 force
	particle dust_color_transition{from_color:16721408,to_color:4456448,scale:0.5} ^ ^ ^0.25 0.1 0.1 0.1 0 1 force
