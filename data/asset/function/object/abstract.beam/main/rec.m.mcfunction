#> asset:object/abstract.beam/main/rec.m
#
...
# 再帰
	execute if score @s _ matches -2147483648..2147483647 unless data storage asset:context this{RemainingRange:0} at @s run function asset:object/abstract.beam/main/rec.m with storage asset:context this
