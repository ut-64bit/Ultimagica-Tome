#> asset:object/proj.water_rain/register
#
# クラスの登録処理
#
...
# ID
	data modify storage asset:object ID set value "proj.water_rain"
# フィールド
	# 飛距離
	data modify storage asset:object Field.Range set value 90
	# 移動速度
