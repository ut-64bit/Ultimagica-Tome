#> asset:object/proj.holy_beam_light_single/tick/state_idle/
#

scoreboard players add @s General.Tick 1

# 発射
	execute if score @s General.Tick matches 1 run function asset:object/proj.holy_beam_light_single/tick/state_idle/macro
