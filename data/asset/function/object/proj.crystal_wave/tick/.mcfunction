...
execute if data storage asset:temp {StateCpy:"delay"} run function asset:object/proj.crystal_wave/tick/state_delay/
execute if data storage asset:temp {StateCpy:"idle"} run function asset:object/proj.crystal_wave/tick/state_idle/
