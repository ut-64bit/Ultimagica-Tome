#> asset:object/proj.thunder_spire/register
#
# クラスの登録処理
#
...
# ID
	data modify storage asset:object ID set value "proj.thunder_spire"
# フィールド
	# 飛距離
	...
	# 爆発するまでの時間
	data modify storage asset:object Field.ExplosionDelay set value 15
