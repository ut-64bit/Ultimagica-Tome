...
execute if score @s General.Tick matches 5 run data merge entity @s { transformation:{ scale:[0.7,0.7,0.7] }, text_opacity:0, interpolation_duration:6, start_interpolation:0 }
