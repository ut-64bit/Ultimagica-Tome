#> asset:object/proj.crystal_bullet_charge_ray/detect_hit_entity/
#
# エンティティの衝突検知に使われるメソッド
#

# エンティティに当たったかどうか判定する
	# execute positioned ~-0.3 ~-0.3 ~-0.3 as @e[type=!#lib:no_living,tag=!_owner,tag=!_this,tag=!Game.Observer,dx=0] \
