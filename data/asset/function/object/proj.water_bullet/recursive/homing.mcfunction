#> asset:object/proj.water_bullet/recursive/homing
#
...
# ホーミングする
	execute if predicate asset:valid_target_id positioned ^ ^ ^-70 facing entity @n[tag=_target,distance=..1000] eyes run rotate @s ~ ~
