#> asset:object/proj.water_bullet/recursive/
#
...
# ホーミング
	...
	execute if predicate asset:valid_target_id run function asset:object/proj.water_bullet/recursive/homing
	execute unless score @s TargetID matches -2147483648..2147483647 run function asset:object/proj.water_bullet/recursive/set_target
