#> asset:attack/holy_judgement/attack_main/
#

execute if score @s AttackTime matches 1 if data storage player:context this.StateMachine.state_data.Field.TargetID run function asset:attack/holy_judgement/attack_main/shot
