#> asset:attack/water_bullet/charge_main/
#
# チャージ中に呼ばれるメソッド
#
...
# ロックオンする
	execute unless data storage player:context this.StateMachine.state_data.Field.TargetID anchored eyes positioned ^ ^ ^ run function asset:attack/water_bullet/charge_main/ray
