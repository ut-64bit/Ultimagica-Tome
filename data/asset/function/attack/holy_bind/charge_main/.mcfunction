#> asset:attack/holy_bind/charge_main/
#
# チャージ中に呼ばれるメソッド
#
...
# ロックオンする
	execute unless data storage player:context this.StateMachine.state_data.Field.TargetID anchored eyes positioned ^ ^ ^ run function asset:attack/holy_bind/charge_main/ray
