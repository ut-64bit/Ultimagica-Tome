...
# スタミナの自然回復
	...
	# スタミナを自然回復する
		...
		execute unless data storage player:context this.StateMachine.state_data.AttackID unless score @s StaminaRecoverDelay matches 1.. run function api:stamina/recover
