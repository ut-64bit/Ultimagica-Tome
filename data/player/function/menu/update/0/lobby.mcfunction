...
execute if entity @s[tag=!Game.Ready] run item replace entity @s player.crafting.0 with structure_void[custom_data={slot:0,menu:{}},item_model="nether_star",max_stack_size=1,custom_name={text:"準備完了",color:"gold",italic:false}]
