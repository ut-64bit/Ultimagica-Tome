...
# 正常終了またはキャンセルのコールバックを呼ぶ
	...
	execute unless function player_manager:attack/is_canceled_transition run function player:state/attack_hold/call_end with storage player:context this.StateMachine.state_data
