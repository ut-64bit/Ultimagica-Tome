...
# 系統強化
data modify storage player_manager:loadout registry.skill append value {id:"school_saint_mastery",description:[{text:"退魔の奇跡の攻撃を10%強化し、詠唱速度をわずかに速くする",color:"gray"},"\n\n退魔の奇跡は、魔族戦争の末期に出現し 終結と共に失われていった\n魔族戦争の英雄である「聖女」が使ったとされ 物事をあるべき形に戻す、特別な力を持つ"],cost:3}
data modify storage player_manager:loadout registry.skill append value {id:"school_holy_mastery",description:{text:"聖教会の祈祷の攻撃を15%強化する",color:"gray"},cost:3}
data modify storage player_manager:loadout registry.skill append value {id:"school_star_mastery",description:[{text:"星詠みの魔術の攻撃を15%強化する",color:"gray"},"\n\n星詠みの魔術は、祈祷の研究の末に生まれた\nしかし、その誕生は望まれたものではなく 星詠みの長い旅の始まりだった"],cost:3}
...
data modify storage player_manager:loadout registry.skill append value {id:"school_gravity_mastery",description:[{text:"重力魔術の攻撃を15%強化する",color:"gray"},"\n\n重力魔術は、魔術で物体を動かす研究で生まれた\n結晶魔術から着想を得て始まったそれは その過程で、人は新たな知識を得ることになる\n星の力を。そして宇宙を"],cost:3}
...
data modify storage player_manager:loadout registry.skill append value {id:"school_elf_mastery",description:[{text:"森人の祈祷の攻撃を15%強化する",color:"gray"},"\n\n森人の祈祷は、森人が使う祈祷である\n森人は、汚染領域の一つ「嵐の樹海」で暮らしている種族\n見目麗しく、寿命が長いことから その血肉は不死の霊薬になるとされる\n主に王国の闇市で、奴隷として高値で取引される"],cost:3}
# data modify storage player_manager:loadout registry.skill append value {id:"school_gem_mastery",description:[{text:"宝石魔術の攻撃を15%強化する",color:"gray"},"\n\n宝石魔術は、魔力と宝石の関係を調べる中で発見された\nこの魔術によって、魔法の保存が可能となり 魔術師の象徴的な杖や、魔道具が生まれた"],cost:3}
# data modify storage player_manager:loadout registry.skill append value {id:"school_dragon_blood_mastery",description:[{text:"竜血の祈祷の攻撃を15%強化する",color:"gray"},"\n\n竜血の祈祷は、王族の持つ力 竜の血を信仰する祈祷\n"],cost:3}
...
# 代償付き
data modify storage player_manager:loadout registry.skill append value {id:"skill_capacity_cursed",description:[{text:"スキルコストが2増えるが、被ダメージが20%上昇する",color:"gray"},"\n\n他ならぬあなたの望みによってこの道は苦難に満ちたものだと約束された"],cost:0,skill_capacity_bonus:1}
...
data modify storage player_manager:loadout registry.skill append value {id:"mana_regeneration_cursed",description:{text:"MP回復速度が50%増加し、MP回復開始までの時間が減少するが、最大MPが50減少する",color:"gray"},cost:1}
data modify storage player_manager:loadout registry.skill append value {id:"magic_slots_cursed",description:[{text:"魔法枠が1つ増えるが、被ダメージが20%上昇する",color:"gray"},"\n\nその記憶は脳裏に焼き付き、決して消えない"],cost:1}
