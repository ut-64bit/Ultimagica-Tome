...
data modify storage player_manager:loadout registry.skill append value {id:"school_crystal_damage",description:[{text:"結晶魔術の攻撃を15%強化する",color:"gray"},"\n\n結晶魔術は、魔術で物質を作り出す研究で生まれた\nしかし、その試みは失敗に終わり 不安定な結晶を生み出すのみだった\nただ、その研究は魔力の性質を多く解明し 後の魔術に大きな影響を与えたという"],cost:3}
...
data modify storage player_manager:loadout registry.skill append value {id:"school_fire_damage",description:{text:"劫火の魔術の攻撃を15%強化する",color:"gray"},cost:3}
